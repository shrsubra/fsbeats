...
Total root disk space of this container.


[float]
=== docker.fs.used.bytes

type: long

Total root disk space used by this container.
...
Total root disk space free in this container.
...
Total root disk usage percent in this container.
